...
## [Unreleased]
### Fixed
* The `flexberry-groupedit` menu item in row direction.


## [2.4.0-beta.9] - 2020-04-29
### Changed
* Update dependency on `ember-flexberry-data` to version `2.4.0-beta.6`.
...
### Changed
* Update dependency on `ember-flexberry-data` to version `2.4.0-beta.3`.
