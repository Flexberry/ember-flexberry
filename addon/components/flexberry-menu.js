...
export default FlexberryBaseComponent.extend({
  ...
  */
  didInsertElement() {
    ...
    $(this.element).on(this.get('onlyClickHandler') ? 'click' : 'click touchstart', onClickHandler);
    ...
    if (!this.get('_skipDropdownInit')) {
      $(this.element).dropdown(this.get('settings'));
    }
  },
  ...
  */
  willDestroyElement() {
    ...
    $(this.element).off('click touchstart', onClickHandler);
  },
