...
export default Component.extend({
  ...
  */
  ...
  setNavDropdownVisibility: function () {
    ...
    if (tab.clientWidth * this.items.length > tabContainer.clientWidth) {
      $(this.navDropdownDomString).show();
    } else {
      $(this.navDropdownDomString).hide();
    }
  },
  ...
  didInsertElement() {
    ...
    slider.addEventListener('wheel', (e) => {
      ...
      // Scroll page.
      $('.dragscroll').scrollLeft($('.dragscroll').scrollLeft() + delta * direction);
    });
  ...
  */
  didRender() {
    ...
    $(this.navDropdownDomString).dropdown({
      transition: 'drop',
      action: 'activate',
      onChange(newTab) {
