...
export default FlexberryBaseComponent.extend(
  ...
  */
  _conditionsByType(type) {
    const getLocaleKey = (key) => t(`components.object-list-view.filters.${key}`);

    const locale = {
      eq: getLocaleKey('eq'),
      neq: getLocaleKey('neq'),
      le: getLocaleKey('le'),
      ge: getLocaleKey('ge'),
      between: getLocaleKey('between'),
      like: getLocaleKey('like'),
      nlike: getLocaleKey('nlike'),
      nempty: getLocaleKey('nempty'),
      empty: getLocaleKey('empty')
    }
