  ...
  actions: {
    ...
    */
    showConfigDialog(settingName) {
      ...
      this.get('modelController').send('showConfigDialog', this.get('componentName'), settingName);
    },
    ...
    */
    showAdvLimitDialog(settingName) {
      ...
      this.get('modelController').send('showAdvLimitDialog', this.get('componentName'), settingName);
    },
    ...
    */
    showExportDialog(settingName, immediateExport) {
      ...
      this.get('modelController').send('showConfigDialog', this.get('componentName'), settName, true, immediateExport);
    },
