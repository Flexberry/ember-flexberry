...
export default EditFormRoute.extend({
  ...
  model(params, transition) {
    let modelName = transition.to.queryParams.modelName || this.modelName;
    let prototypeId = transition.to.queryParams.prototypeId;
    ...
    return promise.then(record => {
      if (isNone(record)) {
        transition.to.queryParams.prototypeId = undefined;
