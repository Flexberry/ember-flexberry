...
ReloadListMixin, {
  ...
  */
  beforeModel(transition) {
    ...
    if (!isNone(transition.to.queryParams.parentRoute)) {
      let thisRouteName = transition.to.queryParams.parentRoute;
      let thisRecordId = transition.to.queryParams.parentRouteRecordId;
  ...
  model(params, transition) {
    ...
    let modelName = transition.to.queryParams.modelName || this.get('modelName');
