...
module.exports = {
    ...
    locals: function (options) {
        ...
        return {
            ...
            lookupLimitFunctions: ""+editFormBlueprint.lookupLimitFunctions.join("\n"),// for use in files\__root__\controllers\__name__.js
    ...
    this.process = function() {
        ...
        for (idx in proj.belongsTo) {
            ...
            if (propertyLookup) {
                ...
                this.lookupLimitFunctions.push(template(this.readSnippetFile("lookupLimitFunction","js"))(belongsTo));
            }
        }
