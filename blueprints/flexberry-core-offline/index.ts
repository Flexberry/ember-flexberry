...
module.exports = {
  ...
  createOfflineSchema: function (options) {
    ...
    for (var _i = 0; _i < modelsFiles.length; _i++) {
      ...
      var model = ModelBlueprint.loadModel(modelsDir, modelFileName);
  ...
  locals: function (options) {
    return {
      offlineSchema: this.createOfflineSchema(options),// for use in files\__root__\services\offline-globals.js
      enableOffline: options.enableOffline// for use in files\__root__\services\offline-globals.js
    };
  }
};
