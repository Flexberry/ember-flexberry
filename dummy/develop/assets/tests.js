...
define('dummy/tests/acceptance/components/flexberry-groupedit/flexberry-groupedit-sort-test', ['qunit', 'dummy/tests/helpers/start-app'], function (_qunit, _startApp) {
  'use strict';

  var app = void 0;
  var flexberryGroupeditComponent = void 0;
  var store = void 0;
  ...
  (0, _qunit.skip)(testName, function (assert) {
    assert.expect(78);
    var recordArray = new Ember.A();
...
define('dummy/tests/acceptance/components/flexberry-lookup/change-component-lookup-test', ['dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test'], function (_executeFlexberryLookupTest) {
  ...
  (0, _executeFlexberryLookupTest.executeTest)('changes in component\'s value causes changes in related model\'s specified \'belongsTo\' relation', function (store, assert, app, latestReceivedRecords) {
    ...
    andThen(function () {
      ...
      var relationName = Ember.get(controller, 'relationName');
      var displayAttributeName = Ember.get(controller, 'displayAttributeName');
      var updateLookupValueTest = Ember.get(controller, 'updateLookupValueTest');
      ...
      openLookupDialog($lookup).then(function ($lookupDialog) {
        ...
        var updateLookupValueTestUpdated = Ember.get(controller, 'updateLookupValueTest');
...
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-custom-window-test', ['ember-flexberry-data/query/builder', 'ember-flexberry-data/query/condition', 'ember-flexberry-data/query/filter-operator', 'ember-flexberry-data/query/predicate', 'dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test'], function (_builder, _condition, _filterOperator, _predicate, _executeFlexberryLookupTest) {
  ...
  (0, _executeFlexberryLookupTest.executeTest)('flexberry-lookup custom window test', function (store, assert, app) {
    ...
    andThen(function () {
      ...
      var waitTime = 2000;
      var nameEtalone = void 0;
      var eMailEtalone = void 0;

      assert.equal(currentURL(), 'components-acceptance-tests/flexberry-lookup/settings-example-custom-window');

      var sp1 = new _predicate.SimplePredicate('name', _filterOperator.default.Neq, '');
      var sp2 = new _predicate.SimplePredicate('eMail', _filterOperator.default.Neq, '');
      var cp = new _predicate.ComplexPredicate(_condition.default.And, sp1, sp2);

      var store = app.__container__.lookup('service:store');
      var builder = new _builder.default(store).from(modelName).selectByProjection('ApplicationUserL').where(cp).top(1);
      store.query(modelName, builder.build()).then(function (result) {
        ...
        var $lookupChooseButton = Ember.$('.ui-change');
        ...
        Ember.run(function () {
          setTimeout(function () {
            var $filterElementOnToolbar = Ember.$('div.olv-search');
            ...
            setTimeout(function () {
              var currentModel = Ember.get(lookupController, 'model');
                    ...
                    setTimeout(function () {
                      ...
                      setTimeout(function () {
                        ...
                        setTimeout(function () {
                          ...
                          setTimeout(function () {
                            currentModel = Ember.get(lookupController, 'model');
                            var filteredInAnotherLookup = Ember.get(currentModel, 'meta.count');
  ...
  (0, _executeFlexberryLookupTest.executeTest)('flexberry-lookup on groupedit custom window test', function (store, assert, app) {
...
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-default-ordering-test', ['dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test'], function (_executeFlexberryLookupTest) {
  'use strict';

  (0, _executeFlexberryLookupTest.executeTest)('flexberry-lookup default ordering test', function (store, assert, app) {
    assert.expect(9);
    ...
    andThen(function () {
      ...
      var $lookupChooseButton = Ember.$('.flexberry-lookup .ui-change');
      ...
      andThen(function () {
        checkHeaderOrder();
        var $menuNextPageButton = Ember.$('.ui.basic.buttons').children('.next-page-button');
      ...
      andThen(function () {
        checkHeaderOrder();
        var $menuCloseButton = Ember.$('.close.icon');
      ...
      andThen(function () {
        checkHeaderOrder();
        var $defaultSortingButton = Ember.$('.ui.button.default-sort');
        click($defaultSortingButton);
      });
    });
  });
...
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-default-user-setting-test', ['dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test'], function (_executeFlexberryLookupTest) {
  ...
  (0, _executeFlexberryLookupTest.executeTest)('flexberry-lookup render olv with default user setting test', function (store, assert) {
    assert.expect(2);
...
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-events-test', ['sinon', 'dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test', 'dummy/tests/acceptance/components/flexberry-lookup/lookup-test-functions'], function (_sinon, _executeFlexberryLookupTest, _lookupTestFunctions) {
  ...
  (0, _executeFlexberryLookupTest.executeTest)('flexberry-lookup events test', function (store, assert, app) {
    ...
    andThen(function () {
      ...
      var compareLookupModalWindowData = function compareLookupModalWindowData(spyCallCountExpected, isInitialCallExpected) {
        ...
        for (var i = 0; i < lookupRecordCount; i++) {
          var suggestionTypeName = Ember.get(dataLoaded.content[i].record, 'name');
          var $cellText = Ember.$($lookupRows[3 * i + 1]).children('div').text().trim();
      ...
      var asyncOperationsCompleted = assert.async();
      (0, _lookupTestFunctions.loadingList)($lookupChouseButton, '.flexberry-modal', '.content table.object-list-view tbody tr').then(function () {
        compareLookupModalWindowData(1, true);
        // Call reload on modal window not closing it.
        var $lookupDialog = Ember.$('.flexberry-modal');
        var $header = Ember.$('.content table.object-list-view thead tr th', $lookupDialog).eq(1);
...
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-prefer-developer-to-default-user-setting-test', ['dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test'], function (_executeFlexberryLookupTest) {
  'use strict';

  (0, _executeFlexberryLookupTest.executeTest)('flexberry-lookup prefer developer to default user setting test', function (store, assert) {
    assert.expect(2);
...
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-prefer-stored-to-default-user-setting-test', ['dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test'], function (_executeFlexberryLookupTest) {
  'use strict';

  (0, _executeFlexberryLookupTest.executeTest)('flexberry-lookup prefer stored to default user setting test', function (store, assert) {
    assert.expect(2);
...
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-window-search-test', ['dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test'], function (_executeFlexberryLookupTest) {
  'use strict';

  (0, _executeFlexberryLookupTest.executeTest)('flexberry-lookup window search test', function (store, assert, app) {
    assert.expect(3);
    ...
    andThen(function () {
      ...
      var $lookupChooseButton = Ember.$('button.ui-change');
      var $sampleText = void 0;

      click($lookupChooseButton);

      //Search exists
      andThen(function () {
        var $windowSearchField = Ember.$('div.block-action-input').children('input');
        var $lookupTable = Ember.$('.content table.object-list-view');
        ...
        var $windowSearchButton = Ember.$('button.search-button');
...
define('dummy/tests/acceptance/components/flexberry-objectlistview/edit-in-modal-open-test', ['dummy/tests/acceptance/components/flexberry-objectlistview/execute-folv-test', 'dummy/locales/ru/translations'], function (_executeFolvTest, _translations) {
  'use strict';

  (0, _executeFolvTest.executeTest)('check edit in modal open', function (store, assert) {
    assert.expect(3);
    var path = 'ember-flexberry-dummy-suggestion-type-list';
    visit(path);
    andThen(function () {
      assert.equal(currentPath(), path);
      var row = Ember.$('.field')[0];
      click(row);
      andThen(function () {
        var $editForm = Ember.$('.flexberry-modal');

        assert.ok($editForm, 'edit form open');
        assert.strictEqual(Ember.$('.flexberry-modal .ui.header')[0].innerText, Ember.get(_translations.default, 'forms.ember-flexberry-dummy-suggestion-type-edit.caption'), 'check header');
...
define('dummy/tests/acceptance/components/flexberry-objectlistview/folv-close-from-edit-form-test', ['dummy/tests/acceptance/components/flexberry-objectlistview/execute-folv-test'], function (_executeFolvTest) {
  'use strict';

  (0, _executeFolvTest.executeTest)('check close button from edit form', function (store, assert) {
    assert.expect(1);
    var path = 'components-acceptance-tests/flexberry-objectlistview/folv-paging';
    visit(path);
    andThen(function () {
...
define('dummy/tests/acceptance/components/flexberry-objectlistview/folv-colsconfig-column-localization-test', ['dummy/tests/acceptance/components/flexberry-objectlistview/execute-folv-test', 'dummy/tests/acceptance/components/flexberry-objectlistview/folv-tests-functions', 'dummy/locales/ru/translations', 'dummy/locales/en/translations'], function (_executeFolvTest, _folvTestsFunctions, _translations, _translations2) {
  ...
  (0, _executeFolvTest.executeTest)('check colsconfig column localization test', function (store, assert, app) {
    assert.expect(21);
    ...
    andThen(function () {
      ...
      function checkLocalization(currentLocale, locale) {
        return new Ember.RSVP.Promise(function (resolve) {
          var columnsLocalization = Ember.get(currentLocale, 'models.ember-flexberry-dummy-suggestion.projections.SuggestionL');

          click('.config-button');
          andThen(function () {
            var $columns = Ember.$('.flexberry-colsconfig tbody tr');
      ...
      (0, _folvTestsFunctions.loadingLocales)('en', app).then(function () {
        checkLocalization(_translations2.default, 'En').then(function () {
          (0, _folvTestsFunctions.loadingLocales)('ru', app).then(function () {
            checkLocalization(_translations.default, 'Ru');
          });
        });
      });
    });
...
define('dummy/tests/acceptance/components/flexberry-objectlistview/folv-delete-record-from-olv-test', ['dummy/tests/acceptance/components/flexberry-objectlistview/execute-folv-test'], function (_executeFolvTest) {
  ...
  (0, _executeFolvTest.executeTest)('check delete record from olv', function (store, assert) {
    assert.expect(1);
    var path = 'components-acceptance-tests/flexberry-objectlistview/folv-paging';
    visit(path);
    andThen(function () {
...
define('dummy/tests/acceptance/components/flexberry-objectlistview/folv-dropdown-filter-for-directories-test', ['dummy/tests/acceptance/components/flexberry-objectlistview/execute-folv-test', 'ember-test-helpers/wait'], function (_executeFolvTest, _wait) {
  'use strict';

  (0, _executeFolvTest.executeTest)('check dropdown in the filter for directories', function (store, assert, app) {
    assert.expect(7);

    var path = 'components-examples/flexberry-objectlistview/custom-filter';
    ...
    andThen(function () {
      ...
      var $olv = Ember.$('.object-list-view');
      var $thead = Ember.$('th', $olv);
      var index = Object.values($thead).findIndex(function (item) {
      ...
      andThen(function () {
        ...
        var $objectListViewFiltersColumns = Ember.$('.object-list-view-filters');
        var $objectListViewFiltersRows = Ember.$($objectListViewFiltersColumns[1]).children();
        ...
        var $dropdownForDirectories = Ember.$($objectListViewFiltersRows[index]).find('.flexberry-dropdown');
        var $menu = $dropdownForDirectories.children('div.menu');
        var $items = $menu.children();

        assert.strictEqual($dropdownForDirectories.length === 1, true, 'Dropdown in the filter for directories is rendered');

        Ember.run(function () {
          return $dropdownForDirectories.click();
        });

        assert.strictEqual($dropdownForDirectories.hasClass('active'), true, 'Dropdown menu is rendered');

        var controller = app.__container__.lookup('controller:' + currentRouteName());
        var filtherResult = controller.model.toArray();
        var isFiltered = true;

        filtherResult.forEach(function (element) {
...
define('dummy/tests/acceptance/components/flexberry-objectlistview/folv-goto-editform-test', ['dummy/tests/acceptance/components/flexberry-objectlistview/execute-folv-test'], function (_executeFolvTest) {
  'use strict';
...
define('dummy/tests/integration/components/flexberry-edit-panel-test', ['ember-i18n/services/i18n', 'ember-flexberry/locales/ru/translations', 'ember-flexberry/locales/en/translations', 'ember-qunit'], function (_i18n, _translations, _translations2, _emberQunit) {
  'use strict';

  (0, _emberQunit.moduleForComponent)('flexberry-dropdown', 'Integration | Component | flexberry edit panel', {
    integration: true,
  ...
  var checkPanelButtons = function checkPanelButtons($panelButtons, panelButtons, assert) {
    ...
    $panelButtons.each(function (i) {
      ...
      assert.strictEqual(Ember.$.trim($item.text()), buttonCaption, 'Component\'s button \u0441aption is a ' + buttonCaption);
  ...
  (0, _emberQunit.test)('flexberry-edit-panel with defaut buttons renders properly', function (assert) {
    assert.expect(21);
    ...
    var $panelButtons = $component.children('button');
    checkPanelButtons($panelButtons, panelButtons, assert);
  });

  (0, _emberQunit.test)('flexberry-edit-panel with custom buttons renders properly', function (assert) {
    assert.expect(24);
    ...
    var $panelButtons = $component.children('button');
    var $menuButtons = $component.children('ui dropdown.menu-buttons');
  ...
  (0, _emberQunit.test)('flexberry-edit-panel with custom buttons and dropdown renders properly', function (assert) {
    assert.expect(20);
    ...
    var $menuItems = $menuButtons.children('.button-dropdown-menu').children('.item');
    var menuItems = panelButtons.slice(2);
    $menuItems.each(function (i) {
      ...
      assert.strictEqual(Ember.$.trim($item.text()), expectButton.text, 'Component\'s dropdown item \u0441aption is a ' + expectButton.text);
    });
  });

  (0, _emberQunit.test)('flexberry-edit-panel with custom buttons and dropdown actions', function (assert) {
    assert.expect(1);

    this.set('actions.buttonClick', function (className) {
...
define('dummy/tests/integration/components/flexberry-lookup-test', ['qunit', 'ember-i18n/services/i18n', 'ember-flexberry/locales/ru/translations', 'ember-flexberry/locales/en/translations', 'ember-qunit', 'dummy/tests/helpers/start-app', 'dummy/tests/helpers/destroy-app'], function (_qunit, _i18n, _translations, _translations2, _emberQunit, _startApp, _destroyApp) {
  'use strict';
...
define('dummy/tests/integration/components/flexberry-simpledatetime-test', ['ember-qunit', 'ember-i18n/services/i18n', 'ember-flexberry/locales/ru/translations', 'ember-flexberry/locales/en/translations'], function (_emberQunit, _i18n, _translations, _translations2) {
  ...
  (0, _emberQunit.test)('properly init value by input', function (assert) {
    ...
    // Retrieve component.
    var $component = this.$();
    var $componentInput = Ember.$('.custom-flatpickr', $component);
...
define('dummy/tests/integration/components/flexberry-sitemap-searchbar-test', ['ember-qunit', 'ember-i18n/services/i18n', 'ember-flexberry/locales/ru/translations', 'ember-flexberry/locales/en/translations', 'dummy/tests/helpers/start-app', 'dummy/tests/helpers/destroy-app'], function (_emberQunit, _i18n, _translations, _translations2, _startApp, _destroyApp) {
  'use strict';

  var app = void 0;

  (0, _emberQunit.moduleForComponent)('flexberry-sitemap-searchbar', 'Integration | Component | flexberry sitemap searchbar', {
    integration: true,
  ...
  (0, _emberQunit.test)('it renders properly', function (assert) {
    ...
    // Retrieve component.
    var $component = this.$().children('.sitemap-searchbar.ui.search');
    $component[0].firstElementChild.click();
    var results = $component.children('.sitemap-search-results-list');

    assert.notEqual(results[0].children.length, 0);

    var value = this.get('i18n').t('forms.application.sitemap.lock.caption');
    var $input = $component.find('.ember-text-field');
    fillIn($input, value);
    andThen(function () {
      ...
      andThen(function () {
        ...
        assert.equal($input[0].value, value);
        assert.equal(results[0].children.length, 1);
        var notFoundMsg = _this.get('i18n').t('components.flexberry-sitemap-searchbar.notFoundMsg');
...
define('dummy/tests/integration/components/flexberry-tab-bar-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';

  (0, _emberQunit.moduleForComponent)('flexberry-tab-bar', 'Integration | Component | flexberry-tab-bar', {
    integration: true
  });
  ...
  (0, _emberQunit.test)('it renders properly', function (assert) {
    ...
    var $component = this.$().children();
    var $menu = $component.children('div.menu');
    var $dropdown = $component.children('div.dropdown');
  ...
  (0, _emberQunit.test)('it renders items', function (assert) {
    assert.expect(10);

    var items = [{ selector: 'tab1', caption: 'Tab №1', active: true }, { selector: 'tab2', caption: 'Tab №2' }, { selector: 'tab3', caption: 'Tab №3' }, { selector: 'tab4', caption: 'Tab №4' }, { selector: 'tab5', caption: 'Tab №5' }];
    ...
    var $component = this.$().children();
    var $menu = $component.children('div.menu');
    var $dropdownMenu = $component.children('div.dropdown').children('div.menu');
    var $menuItems = $menu.children('button.item');
    var $dropdownItems = $dropdownMenu.children('button.item');
  ...
  (0, _emberQunit.test)('tabs are switched in menu and in dropdown list', function (assert) {
    ...
    // To select some item, menu must contain such item (with the specified caption).
    var $itemMenu = Ember.$('.item:contains(' + this.get('items')[1].caption + ')', $menu);
    var $itemDropdown = Ember.$('.item:contains(' + this.get('items')[1].caption + ')', $dropdown);
...
define('dummy/tests/integration/components/flexberry/validation-summary-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
