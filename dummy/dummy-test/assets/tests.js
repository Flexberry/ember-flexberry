...
define('dummy/tests/acceptance/components/flexberry-groupedit/flexberry-groupedit-default-sort-test', ['exports', 'ember', 'qunit', 'dummy/tests/helpers/start-app'], function (exports, _ember, _qunit, _dummyTestsHelpersStartApp) {
  ...
  (0, _qunit.test)(testName, function (assert) {
    ...
    andThen(function () {
      ...
      var $usersVotesTable = _ember['default'].$('.object-list-view')[1];
      ...
      andThen(function () {
        ...
        var $defaultSortingButton = _ember['default'].$('.object-list-view .clear-sorting-button')[0];
        ...
        andThen(function () {
          ...
          andThen(function () {
            currentSorting = controller.get('sorting')[0];
            assert.ok(currentSorting.propName === 'voteType', currentSorting.direction === 'asc', 'sorting changed');
            var $clearSettingsButton = _ember['default'].$('.ui-clear-settings')[0];
...
define('dummy/tests/acceptance/components/flexberry-groupedit/flexberry-groupedit-delete-with-details-test', ['exports', 'ember', 'ember-flexberry-data/utils/generate-unique-id', 'ember-flexberry-data/query/builder', 'ember-flexberry-data/query/predicate', 'qunit', 'dummy/tests/helpers/start-app'], function (exports, _ember, _emberFlexberryDataUtilsGenerateUniqueId, _emberFlexberryDataQueryBuilder, _emberFlexberryDataQueryPredicate, _qunit, _dummyTestsHelpersStartApp) {
  ...
  (0, _qunit.test)('delete with details', function (assert) {
    ...
    var checkRecordsWereAdded = function checkRecordsWereAdded(searchedRecord) {
      ...
      var recordIsForDeleting = $rows().reduce(function (sum, element) {
        var nameRecord = _ember['default'].$.trim(element.children[1].children[0].children[0].value);
    ...
    var getDeleteButton = function getDeleteButton(searchedRecord) {
      ...
      $rows().forEach(function (element) {
        ...
        if (nameRecord.indexOf(searchedRecord) >= 0) {
          $deleteBtnInRow = _ember['default'].$('.object-list-view-row-delete-button', element);
        }
      });
    ...
    _ember['default'].run(function () {
      ...
      var createdRecordsPrefix = 'fge-delete-with-details-test' + (0, _emberFlexberryDataUtilsGenerateUniqueId['default'])();
      initTestData(createdRecordsPrefix).then(function () {
        ...
        andThen(function () {
          ...
          wait().then(function () {
            ...
            var builder = new _emberFlexberryDataQueryBuilder['default'](store, commentModelName).where(new _emberFlexberryDataQueryPredicate.SimplePredicate('text', "==", createdRecordsPrefix + "0"));
            ...
            store.query(commentModelName, builder.build()).then(function (data) {
              ...
              var builder = new _emberFlexberryDataQueryBuilder['default'](store, commentVoteModelName).where(new _emberFlexberryDataQueryPredicate.SimplePredicate('comment.text', "==", createdRecordsPrefix + "0"));
...
define('dummy/tests/acceptance/components/flexberry-groupedit/flexberry-groupedit-sort-test', ['exports', 'ember', 'qunit', 'dummy/tests/helpers/start-app'], function (exports, _ember, _qunit, _dummyTestsHelpersStartApp) {

  var app = undefined;
  var flexberryGroupeditComponent = undefined;
  var store = undefined;
  var testName = 'sort test';

  (0, _qunit.module)('Acceptance | flexberry-groupedit | ' + testName, {
    needs: ['model:ember-flexberry-dummy-suggestion'],
    beforeEach: function beforeEach() {
      // Start application.
      app = (0, _dummyTestsHelpersStartApp['default'])();
  ...
  (0, _qunit.test)(testName, function (assert) {
    assert.expect(78);
    var recordArray = new _ember['default'].A();

    _ember['default'].run(function () {
      recordArray.insertAt(0, store.createRecord('ember-flexberry-dummy-suggestion', {
        id: 1,
        address: 'Alphabeth5',
        text: 'Beatrith5',
      ...
      recordArray.insertAt(1, store.createRecord('ember-flexberry-dummy-suggestion', {
        id: 2,
        address: 'Alphabeth4',
        text: 'Beatrith4',
      ...
      recordArray.insertAt(2, store.createRecord('ember-flexberry-dummy-suggestion', {
        id: 3,
        address: 'Alphabeth3',
        text: 'Beatrith1',
      ...
      recordArray.insertAt(3, store.createRecord('ember-flexberry-dummy-suggestion', {
        id: 4,
        address: 'Alphabeth2',
        text: 'Beatrith2',
      ...
      recordArray.insertAt(4, store.createRecord('ember-flexberry-dummy-suggestion', {
        id: 5,
        address: 'Alphabeth1',
        text: 'Beatrith3',
    ...
    try {
      var sortResult = flexberryGroupeditComponent.sortRecords(recordArray, { propName: 'address', direction: 'asc' }, 0, 4);
...
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-custom-window-test', ['exports', 'ember', 'ember-flexberry-data', 'ember-flexberry-data/query/condition', 'ember-flexberry-data/query/filter-operator', 'dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test'], function (exports, _ember, _emberFlexberryData, _emberFlexberryDataQueryCondition, _emberFlexberryDataQueryFilterOperator, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest) {
  ...
  (0, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest.executeTest)('flexberry-lookup custom window test', function (store, assert, app) {
    ...
    andThen(function () {
      var modelName = 'ember-flexberry-dummy-application-user';
      var waitTime = 2000;
      var nameEtalone = undefined;
      var eMailEtalone = undefined;

      assert.equal(currentURL(), 'components-acceptance-tests/flexberry-lookup/settings-example-custom-window');

      var sp1 = new SimplePredicate('name', _emberFlexberryDataQueryFilterOperator['default'].Neq, '');
      var sp2 = new SimplePredicate('eMail', _emberFlexberryDataQueryFilterOperator['default'].Neq, '');
      var cp = new ComplexPredicate(_emberFlexberryDataQueryCondition['default'].And, sp1, sp2);

      var store = app.__container__.lookup('service:store');
      var builder = new _emberFlexberryData.Query.Builder(store).from(modelName).selectByProjection('ApplicationUserL').where(cp).top(1);
      store.query(modelName, builder.build()).then(function (result) {
        ...
        var $lookupChooseButton = _ember['default'].$('.ui-change');
        ...
        _ember['default'].run(function () {
          setTimeout(function () {
            var $filterElementOnToolbar = _ember['default'].$('div.olv-search');
            assert.equal($filterElementOnToolbar.length, 1, 'Lookup window has filter element on toolbar.');
            var $filterInput = _ember['default'].$('div.olv-search input');
            var $filterApplyButton = _ember['default'].$('div.olv-search button.search-button');
            var lookupController = app.__container__.lookup('controller:lookup-dialog');
            ...
            setTimeout(function () {
              var currentModel = _ember['default'].get(lookupController, 'model');
              var filteredByCommonProjectionCountN = _ember['default'].get(currentModel, 'meta.count');
              ...
              var $closeIcon = _ember['default'].$('i.close');
              _ember['default'].run(function () {
                $closeIcon.click();
              });
              ...
              setTimeout(function () {
                ...
                var testController = app.__container__.lookup('controller:' + currentRouteName());
                _ember['default'].run(function () {
                  _ember['default'].set(testController, 'filterProjectionName', 'TestLookupCustomWindow');
                  _ember['default'].set(testController, 'projectionName', 'ApplicationUserE');
                });
                ...
                var done4 = assert.async();
                setTimeout(function () {
                  $filterElementOnToolbar = _ember['default'].$('div.olv-search');
                  assert.equal($filterElementOnToolbar.length, 1, 'Lookup window has filter element on toolbar.');
                  $filterInput = _ember['default'].$('div.olv-search input');
                  $filterApplyButton = _ember['default'].$('div.olv-search button.search-button');
                  _ember['default'].run(function () {
                  ...
                  var done5 = assert.async();
                  setTimeout(function () {
                    currentModel = _ember['default'].get(lookupController, 'model');
                    var filteredByFilterProjectionCount = _ember['default'].get(currentModel, 'meta.count');
                    ...
                    setTimeout(function () {
                      currentModel = _ember['default'].get(lookupController, 'model');
                      var filteredByFilterProjectionCount2 = _ember['default'].get(currentModel, 'meta.count');
                      ...
                      $closeIcon = _ember['default'].$('i.close');
                      _ember['default'].run(function () {
                        $closeIcon.click();
                      });
                      ...
                      setTimeout(function () {
                        ...
                        setTimeout(function () {
                          ...
                          setTimeout(function () {
                            currentModel = _ember['default'].get(lookupController, 'model');
                            var filteredInAnotherLookup = _ember['default'].get(currentModel, 'meta.count');
  ...
  (0, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest.executeTest)('flexberry-lookup on groupedit custom window test', function (store, assert, app) {
...
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-default-ordering-test', ['exports', 'ember', 'dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test'], function (exports, _ember, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest) {

  (0, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest.executeTest)('flexberry-lookup default ordering test', function (store, assert, app) {
    assert.expect(9);
    var path = 'components-examples/flexberry-lookup/default-ordering-example';
    visit(path);

    function checkHeaderOrder() {
      var defaultSorting = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];

      var $menuTableHeaders = _ember['default'].$('.content table.object-list-view thead tr th');
    ...
    andThen(function () {
      ...
      var $lookupChooseButton = _ember['default'].$('.flexberry-lookup .ui-change');
      ...
      andThen(function () {
        checkHeaderOrder();
        var $menuNextPageButton = _ember['default'].$('.ui.basic.buttons').children('.next-page-button');
      ...
      andThen(function () {
        checkHeaderOrder();
        var $menuCloseButton = _ember['default'].$('.close.icon');
      ...
      andThen(function () {
        checkHeaderOrder();
        var $defaultSortingButton = _ember['default'].$('.ui.button.default-sort');
        click($defaultSortingButton);
      });
    });
  });
...
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-events-test', ['exports', 'ember', 'sinon', 'dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test', 'dummy/tests/acceptance/components/flexberry-lookup/lookup-test-functions'], function (exports, _ember, _sinon, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest, _dummyTestsAcceptanceComponentsFlexberryLookupLookupTestFunctions) {

  (0, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest.executeTest)('flexberry-lookup events test', function (store, assert, app) {
    ...
    andThen(function () {
      ...
      var lookupEventsService = app.__container__.lookup('service:lookup-events');
      assert.notEqual(lookupEventsService, null);

      // Spy on event triggering.
      var spy = _sinon['default'].spy(lookupEventsService, "lookupDialogOnDataLoadedTrigger");
      var $lookupChouseButton = _ember['default'].$('.ui-change');
      assert.ok(spy.notCalled);

      var compareLookupModalWindowData = function compareLookupModalWindowData(spyCallCountExpected, isInitialCallExpected) {
        ...
        var $lookupDialog = _ember['default'].$('.flexberry-modal');
        var $records = _ember['default'].$('.content table.object-list-view tbody tr', $lookupDialog);
        var $lookupRows = $records.children('td');
        ...
        for (var i = 0; i < lookupRecordCount; i++) {
          var suggestionTypeName = _ember['default'].get(dataLoaded.content[i].record, 'name');
          var $cellText = _ember['default'].$($lookupRows[3 * i + 1]).children('div').text().trim();
      ...
      var asyncOperationsCompleted = assert.async();
      (0, _dummyTestsAcceptanceComponentsFlexberryLookupLookupTestFunctions.loadingList)($lookupChouseButton, '.flexberry-modal', '.content table.object-list-view tbody tr').then(function () {
        compareLookupModalWindowData(1, true);
        // Call reload on modal window not closing it.
        var $lookupDialog = _ember['default'].$('.flexberry-modal');
        var $header = _ember['default'].$('.content table.object-list-view thead tr th', $lookupDialog).eq(1);
        assert.equal(spy.callCount, 1);

        // Lookup dialog successfully opened & data is loaded.
        // Try to change sorting.
        return (0, _dummyTestsAcceptanceComponentsFlexberryLookupLookupTestFunctions.loadingList)($header, '.flexberry-modal', '.content table.object-list-view tbody tr');
      }).then(function () {
...
define('dummy/tests/acceptance/components/flexberry-lookup/flexberry-lookup-window-search-test', ['exports', 'ember', 'dummy/tests/acceptance/components/flexberry-lookup/execute-flexberry-lookup-test'], function (exports, _ember, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest) {

  (0, _dummyTestsAcceptanceComponentsFlexberryLookupExecuteFlexberryLookupTest.executeTest)('flexberry-lookup window search test', function (store, assert, app) {
    assert.expect(3);
    var path = 'components-examples/flexberry-lookup/customizing-window-example';
    visit(path);

    andThen(function () {
      assert.equal(currentPath(), path);

      var $lookupChooseButton = _ember['default'].$('button.ui-change');
      var $sampleText = undefined;

      click($lookupChooseButton);

      //Search exists
      andThen(function () {
        var $windowSearchField = _ember['default'].$('div.block-action-input').children('input');
        var $lookupTable = _ember['default'].$('.content table.object-list-view');
        var $lookupTableBody = $lookupTable.children('tbody');
        var $lookupTableRow = $lookupTableBody.children('tr');
        var $lookupTableRowText = $lookupTableRow.find('div.oveflow-text').eq(2);
        ...
        var $windowSearchButton = _ember['default'].$('button.search-button');
        ...
        andThen(function () {
          ...
          var $lookupTableBody = $lookupTable.children('tbody');
          var $lookupTableRow = $lookupTableBody.children('tr');
          var $lookupTableRowText = $lookupTableRow.find('div.oveflow-text').first();
...
define('dummy/tests/acceptance/components/flexberry-objectlistview/filther/folv-filter-on-toolbar-test', ['exports', 'ember', 'dummy/tests/acceptance/components/flexberry-objectlistview/execute-folv-test', 'ember-flexberry-data', 'ember-flexberry-data/query/condition', 'ember-flexberry-data/query/filter-operator', 'ember-flexberry-data/query/predicate', 'dummy/tests/acceptance/components/flexberry-objectlistview/folv-tests-functions'], function (exports, _ember, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewExecuteFolvTest, _emberFlexberryData, _emberFlexberryDataQueryCondition, _emberFlexberryDataQueryFilterOperator, _emberFlexberryDataQueryPredicate, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions) {

  (0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewExecuteFolvTest.executeTest)('check filter on toolbar with filter projection', function (store, assert, app) {
    assert.expect(5);
    var path = 'components-acceptance-tests/flexberry-objectlistview/custom-filter';
    var modelName = 'ember-flexberry-dummy-suggestion';
    var adressEtalone = undefined;
    var typeNameEtalone = undefined;

    visit(path);
    andThen(function () {
      assert.equal(currentPath(), path);
      var sp1 = new _emberFlexberryDataQueryPredicate.SimplePredicate('address', _emberFlexberryDataQueryFilterOperator['default'].Neq, '');
      var sp2 = new _emberFlexberryDataQueryPredicate.SimplePredicate('type.name', _emberFlexberryDataQueryFilterOperator['default'].Neq, '');
      var cp = new _emberFlexberryDataQueryPredicate.ComplexPredicate(_emberFlexberryDataQueryCondition['default'].And, sp1, sp2);

      var builder = new _emberFlexberryData.Query.Builder(store).from(modelName).selectByProjection('SuggestionL').where(cp).top(1);
      store.query(modelName, builder.build()).then(function (result) {
        var arr = result.toArray();
        ...
        (0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions.refreshListByFunction)(refreshFunction, controller).then(function ($list) {
          var currentModel = _ember['default'].get(controller, 'model');
          var filteredByCommonProjectionCountN = _ember['default'].get(currentModel, 'meta.count');
          ...
          _ember['default'].run(function () {
            _ember['default'].set(controller, 'filterProjectionName', 'TestFilterOnToolbarView');
          });
          ...
          (0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions.refreshListByFunction)(refreshFunction, controller).then(function ($list) {
            ...
            (0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions.refreshListByFunction)(refreshFunction, controller).then(function ($list) {
              ...
              _ember['default'].run(function () {
                _ember['default'].set(controller, 'filterProjectionName', undefined);
              });
              done3();
            });
...
define('dummy/tests/acceptance/components/flexberry-objectlistview/folv-colsconfig-column-localization-test', ['exports', 'ember', 'dummy/tests/acceptance/components/flexberry-objectlistview/execute-folv-test', 'dummy/tests/acceptance/components/flexberry-objectlistview/folv-tests-functions', 'dummy/locales/ru/translations', 'dummy/locales/en/translations'], function (exports, _ember, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewExecuteFolvTest, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions, _dummyLocalesRuTranslations, _dummyLocalesEnTranslations) {

  (0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewExecuteFolvTest.executeTest)('check colsconfig column localization test', function (store, assert, app) {
    assert.expect(21);
    ...
    andThen(function () {
      ...
      function checkLocalization(currentLocale, locale) {
        var columnsLocalization = _ember['default'].get(currentLocale, 'models.ember-flexberry-dummy-suggestion.projections.SuggestionL');

        var $configButton = _ember['default'].$('.config-button');
        $configButton.click();

        var $columns = _ember['default'].$('.flexberry-colsconfig tbody tr');
        $columns.each(function (i, column) {
          ...
          var caption = _ember['default'].get(columnsLocalization, propname + '.__caption__');
          assert.equal(caption, cellText, assertionMessage);
        });

        var $closeModal = _ember['default'].$('.close.icon');
        $closeModal.click();
      }

      (0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions.loadingLocales)('en', app).then(function () {
        checkLocalization(_dummyLocalesEnTranslations['default'], 'En');
        (0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions.loadingLocales)('ru', app).then(function () {
          checkLocalization(_dummyLocalesRuTranslations['default'], 'Ru');
        });
      });
    });
  });
...
define('dummy/tests/acceptance/components/flexberry-objectlistview/folv-delete-with-details-test', ['exports', 'ember', 'dummy/tests/acceptance/components/flexberry-objectlistview/execute-folv-test', 'ember-flexberry-data/utils/generate-unique-id', 'ember-flexberry-data/query/builder', 'ember-flexberry-data/query/predicate'], function (exports, _ember, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewExecuteFolvTest, _emberFlexberryDataUtilsGenerateUniqueId, _emberFlexberryDataQueryBuilder, _emberFlexberryDataQueryPredicate) {

  (0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewExecuteFolvTest.executeTest)('check delete with details', function (store, assert, app) {
    assert.expect(25);
    ...
    var checkRecordsWereAdded = function checkRecordsWereAdded(searchedRecord) {
      ...
      // Check that the records have been added.
      var recordIsForDeleting = $rows().reduce(function (sum, element) {
        var nameRecord = _ember['default'].$.trim(element.children[2].innerText);
        var flag = nameRecord.indexOf(searchedRecord) >= 0;
        return sum + flag;
      }, 0);
    ...
    _ember['default'].run(function () {
      var done1 = assert.async();
      var createdRecordsPrefix = 'folv-delete-with-details-test' + (0, _emberFlexberryDataUtilsGenerateUniqueId['default'])();
      initTestData(createdRecordsPrefix).then(function () {
        var builder = new _emberFlexberryDataQueryBuilder['default'](store).from(modelName).count();
        var done = assert.async();
        store.query(modelName, builder.build()).then(function (result) {
          visit(path + '?perPage=' + result.meta.count);
          andThen(function () {
            ...
            wait().then(function () {
              ...
              var builder = new _emberFlexberryDataQueryBuilder['default'](store, modelName).where(new _emberFlexberryDataQueryPredicate.SimplePredicate('text', "==", createdRecordsPrefix + "0"));
              var done3 = assert.async();
...
define('dummy/tests/acceptance/components/flexberry-objectlistview/folv-user-settings-on-multi-list-test', ['exports', 'ember', 'qunit', 'dummy/tests/helpers/start-app', 'dummy/tests/acceptance/components/flexberry-objectlistview/folv-tests-functions', 'ember-flexberry-data/utils/generate-unique-id'], function (exports, _ember, _qunit, _dummyTestsHelpersStartApp, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions, _emberFlexberryDataUtilsGenerateUniqueId) {
  ...
  (0, _qunit.module)('Acceptance | flexberry-objectlistview | per page user settings on multi list', {
    beforeEach: function beforeEach() {
      ...
      _ember['default'].set(userService, 'isUserSettingsServiceEnabled', true);
    },
  ...
  (0, _qunit.test)('check perPage developerUserSetting in multi list', function (assert) {
    ...
    var modelInfos = [{ modelName: 'ember-flexberry-dummy-application-user', uuid: (0, _emberFlexberryDataUtilsGenerateUniqueId['default'])(), componentName: 'MultiUserList', perPage: [9, 12, 9, 15] }, { modelName: 'ember-flexberry-dummy-application-user', uuid: (0, _emberFlexberryDataUtilsGenerateUniqueId['default'])(), componentName: 'MultiUserList2', perPage: [10, 13, 13, 16] }, { modelName: 'ember-flexberry-dummy-suggestion-type', uuid: (0, _emberFlexberryDataUtilsGenerateUniqueId['default'])(), componentName: 'MultiSuggestionList', perPage: [11, 14, 11, 17] }];

    _ember['default'].set(route, 'developerUserSettings', {
    ...
    try {
      (function () {
        ...
        andThen(function () {
          ...
          _ember['default'].set(userService, 'isUserSettingsServiceEnabled', false);

          // Remove current saved not in Database settings.
          _ember['default'].set(userService, 'currentUserSettings', {});
  ...
  function checkPaging(assert, modelInfos, expectedIndex) {
    // check paging.
    var $perPageElement = _ember['default'].$('div.flexberry-dropdown div.text');
  ...
  function initTestData(store, modelInfos) {
    return _ember['default'].RSVP.Promise.all([(0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions.addRecords)(store, modelInfos[0].modelName, modelInfos[0].uuid), (0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions.addRecords)(store, modelInfos[1].modelName, modelInfos[1].uuid), (0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions.addRecords)(store, modelInfos[2].modelName, modelInfos[2].uuid)]);
  }
  ...
  function removeTestData(assert, store, modelInfos) {
    return _ember['default'].RSVP.Promise.all([(0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions.deleteRecords)(store, modelInfos[0].modelName, modelInfos[0].uuid, assert), (0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions.deleteRecords)(store, modelInfos[1].modelName, modelInfos[1].uuid, assert), (0, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions.deleteRecords)(store, modelInfos[2].modelName, modelInfos[2].uuid, assert)]);
  }

  function deleteAllUserSettings(assert, modelInfos) {
    return _ember['default'].RSVP.Promise.all([deleteUserSetting(assert, modelInfos[0].componentName), deleteUserSetting(assert, modelInfos[1].componentName), deleteUserSetting(assert, modelInfos[2].componentName)]);
  }
...
define('dummy/tests/acceptance/components/flexberry-objectlistview/folv-user-settings-test', ['exports', 'ember', 'qunit', 'dummy/tests/helpers/start-app', 'dummy/tests/acceptance/components/flexberry-objectlistview/folv-tests-functions', 'ember-flexberry-data/utils/generate-unique-id'], function (exports, _ember, _qunit, _dummyTestsHelpersStartApp, _dummyTestsAcceptanceComponentsFlexberryObjectlistviewFolvTestsFunctions, _emberFlexberryDataUtilsGenerateUniqueId) {
                          ...
                          (function () {
                            ...
                            andThen(function () {
                              try {
                                ...
                                assert.ok(_currentUrl.contains("perPage=17"), "Переадресация выполнена успешно (настройка взята из developerUserSettings).");
...
define('dummy/tests/acceptance/components/flexberry-simpledatetime/flexberry-simpledatetime-manual-enter-test', ['exports', 'ember', 'qunit', 'dummy/tests/helpers/start-app'], function (exports, _ember, _qunit, _dummyTestsHelpersStartApp) {
  ...
  (0, _qunit.test)('manual enter on groupedit', function (assert) {
    ...
    andThen(function () {
      ...
      var controller = app.__container__.lookup('controller:' + currentRouteName());
      var detailModels = _ember['default'].get(controller, 'model.details');
      assert.equal(detailModels.length, 2, 'Data contains two details as expected');

      var $datePickers = _ember['default'].$('.flatpickr-input.custom-flatpickr');
      assert.equal($datePickers.length, 2, 'There are two rows on groupedit.');
      fillIn($datePickers[0], '01.01.2022');
      andThen(function () {
        assert.equal('2022-01-01', _ember['default'].get(detailModels.objectAt(0), 'date').toISOString().split('T')[0], 'Properly initiated by custom date');
        var today = new Date();
        ...
        andThen(function () {
          assert.equal(today.toISOString().split('T')[0], _ember['default'].get(detailModels.objectAt(1), 'date').toISOString().split('T')[0], 'Properly initiated by current date');
        });
      });
    });
  });
});
define('dummy/tests/acceptance/components/flexberry-toggler/flexberry-toggler-with-inner-toggler-test', ['exports', 'ember', 'qunit', 'dummy/tests/helpers/start-app'], function (exports, _ember, _qunit, _dummyTestsHelpersStartApp) {
  ...
  (0, _qunit.test)(testName, function (assert) {
    ...
    andThen(function () {
      ...
      var rows = _ember['default'].$('table.flexberry-word-break tbody tr');
      var caption = _ember['default'].$('.ember-text-field', rows[0]);
      fillIn(caption, 'Caption text example');

      andThen(function () {
        var title1 = _ember['default'].$('.title')[0].innerText;
        assert.equal(caption[0].value, title1, 'Caption is correct');

        var expandedInnerCaption = _ember['default'].$('.ember-text-field', rows[5]);
        var collapsedInnerCaption = _ember['default'].$('.ember-text-field', rows[6]);
        ...
        var expandedCaption = _ember['default'].$('.ember-text-field', rows[1]);
        var collapsedCaption = _ember['default'].$('.ember-text-field', rows[2]);
        fillIn(expandedCaption, 'Expanded caption text example');
        fillIn(collapsedCaption, 'Collapsed caption text example');

        andThen(function () {
          var toggler = _ember['default'].$('.flexberry-toggler .title');
            ...
            andThen(function () {
              ...
              andThen(function () {
                ...
                andThen(function () {
                  ...
                  assert.equal(expandedCheckbox.checked, true, 'expanded=true');
                  var icon = _ember['default'].$('.flexberry-toggler .title .icon')[0];
                  assert.equal(icon.className, 'dropdown icon', 'dropdown icon');
                  var collapsedCaption = _ember['default'].$('.ember-text-field', rows[8]);
...
define('dummy/tests/acceptance/edit-form-validation-test/validation-file-test', ['exports', 'ember', 'dummy/tests/acceptance/edit-form-validation-test/execute-validation-test'], function (exports, _ember, _dummyTestsAcceptanceEditFormValidationTestExecuteValidationTest) {
  ...
  (0, _dummyTestsAcceptanceEditFormValidationTestExecuteValidationTest.executeTest)('check operation file', function (store, assert, app) {
    ...
    andThen(function () {
      ...
      var $validationFlexberryLookupButton = _ember['default'].$('.ui.button.ui-change')[0];
...
define('dummy/tests/acceptance/edit-form-validation-test/validation-textbox-unique-date-test', ['exports', 'ember', 'dummy/tests/acceptance/edit-form-validation-test/execute-validation-test', 'ember-flexberry-data/utils/generate-unique-id'], function (exports, _ember, _dummyTestsAcceptanceEditFormValidationTestExecuteValidationTest, _emberFlexberryDataUtilsGenerateUniqueId) {

    (0, _dummyTestsAcceptanceEditFormValidationTestExecuteValidationTest.executeTest)('check operation text+date unique', function (store, assert, _app) {
        assert.expect(3);
        ...
        _ember['default'].run(function () {
            ...
            initTestData('uniqueTest' + (0, _emberFlexberryDataUtilsGenerateUniqueId['default'])()).then(function (suggestion) {
                // Open validation page.
                visit(path);
                ...
                andThen(function () {
                    ...
                    // data
                    var $validationDateField = _ember['default'].$(_ember['default'].$('.field.error')[4]);
                    var $validationDate = _ember['default'].$('.flexberry-simpledatetime', $validationDateField);
                    var $validationDateFlatpickr = _ember['default'].$('.flatpickr > input', $validationDate);
                    var $validationDateFlatpickrCustom = _ember['default'].$('input.custom-flatpickr', $validationDate);
...
define('dummy/tests/integration/components/flexberry-lookup-test', ['exports', 'ember', 'ember-flexberry-data', 'ember-i18n/services/i18n', 'ember-flexberry/locales/ru/translations', 'ember-flexberry/locales/en/translations', 'ember-qunit', 'dummy/tests/helpers/start-app', 'dummy/tests/helpers/destroy-app'], function (exports, _ember, _emberFlexberryData, _emberI18nServicesI18n, _emberFlexberryLocalesRuTranslations, _emberFlexberryLocalesEnTranslations, _emberQunit, _dummyTestsHelpersStartApp, _dummyTestsHelpersDestroyApp) {
  ...
  (0, _emberQunit.test)('autocompleteDirection adds no css-class if autocompleteDirection is not defined', function (assert) {
    var _this6 = this;

    var store = app.__container__.lookup('service:store');

    _ember['default'].run(function () {
      _ember['default'].set(_this6, 'model', store.createRecord('ember-flexberry-dummy-suggestion', {
        name: 'TestTypeName'
      }));
      ...
      _this6.render(_ember['default'].HTMLBars.template((function () {
        return {
          ...
          statements: [['inline', 'flexberry-lookup', [], ['value', ['subexpr', '@mut', [['get', 'model.type', ['loc', [null, [2, 12], [2, 22]]]]], [], []], 'relationName', 'parent', 'projection', 'SettingLookupExampleView', 'displayAttributeName', 'name', 'title', 'Parent', 'autocomplete', true, 'relatedModel', ['subexpr', '@mut', [['get', 'model', ['loc', [null, [8, 19], [8, 24]]]]], [], []], 'relationName', 'type'], ['loc', [null, [1, 0], [10, 6]]]]],
          locals: [],
          templates: []
        };
      })()));
    ...
    var $resultAutocomplete = this.$('div.results');
    ...
    var $lookupField = this.$('input.lookup-field');
  ...
  (0, _emberQunit.test)('autocompleteDirection adds css-class if autocompleteDirection is defined as upward', function (assert) {
    var _this7 = this;

    var store = app.__container__.lookup('service:store');

    _ember['default'].run(function () {
      _ember['default'].set(_this7, 'model', store.createRecord('ember-flexberry-dummy-suggestion', {
        name: 'TestTypeName'
      }));

      _ember['default'].set(_this7, 'autocompleteDirection', undefined);
      _this7.render(_ember['default'].HTMLBars.template((function () {
        return {
          meta: {
            'fragmentReason': {
          ...
          statements: [['inline', 'flexberry-lookup', [], ['value', ['subexpr', '@mut', [['get', 'model.type', ['loc', [null, [2, 12], [2, 22]]]]], [], []], 'relationName', 'parent', 'projection', 'SettingLookupExampleView', 'displayAttributeName', 'name', 'title', 'Parent', 'autocomplete', true, 'autocompleteDirection', 'upward', 'relatedModel', ['subexpr', '@mut', [['get', 'model', ['loc', [null, [9, 19], [9, 24]]]]], [], []], 'relationName', 'type'], ['loc', [null, [1, 0], [11, 6]]]]],
          locals: [],
          templates: []
        };
      })()));
  ...
  (0, _emberQunit.test)('autocompleteDirection adds no css-class if autocompleteDirection is defined as downward', function (assert) {
    var _this8 = this;

    var store = app.__container__.lookup('service:store');

    _ember['default'].run(function () {
      _ember['default'].set(_this8, 'model', store.createRecord('ember-flexberry-dummy-suggestion', {
        name: 'TestTypeName'
      }));
      ...
      _this8.render(_ember['default'].HTMLBars.template((function () {
        return {
          ...
          statements: [['inline', 'flexberry-lookup', [], ['value', ['subexpr', '@mut', [['get', 'model.type', ['loc', [null, [2, 12], [2, 22]]]]], [], []], 'relationName', 'parent', 'projection', 'SettingLookupExampleView', 'displayAttributeName', 'name', 'title', 'Parent', 'autocomplete', true, 'autocompleteDirection', 'downward', 'relatedModel', ['subexpr', '@mut', [['get', 'model', ['loc', [null, [9, 19], [9, 24]]]]], [], []], 'relationName', 'type'], ['loc', [null, [1, 0], [11, 6]]]]],
          locals: [],
          templates: []
        };
      })()));
...
define('dummy/tests/integration/components/flexberry-simpledatetime-test', ['exports', 'ember-qunit', 'ember', 'ember-i18n/services/i18n', 'ember-flexberry/locales/ru/translations', 'ember-flexberry/locales/en/translations'], function (exports, _emberQunit, _ember, _emberI18nServicesI18n, _emberFlexberryLocalesRuTranslations, _emberFlexberryLocalesEnTranslations) {
  ...
  (0, _emberQunit.test)('properly init value by input', function (assert) {
    var _this = this;

    assert.expect(1);
    var typeName = 'date';
    _ember['default'].set(this, 'type', typeName);
    _ember['default'].set(this, 'dateValue', undefined);
    ...
    this.render(_ember['default'].HTMLBars.template((function () {
      return {
        ...
        statements: [['inline', 'flexberry-simpledatetime', [], ['type', ['subexpr', '@mut', [['get', 'type', ['loc', [null, [2, 11], [2, 15]]]]], [], []], 'value', ['subexpr', '@mut', [['get', 'dateValue', ['loc', [null, [3, 12], [3, 21]]]]], [], []]], ['loc', [null, [1, 0], [4, 6]]]]],
        locals: [],
        templates: []
      };
    })()));
    ...
    _ember['default'].run(function () {
      ...
      assert.equal(_ember['default'].get(_this, 'dateValue').toISOString().split('T')[0], '2022-01-01');
    });
  });
});
...
define('dummy/tests/integration/components/flexberry-validationsummary-test', ['exports', 'ember-qunit', 'ember-validations/errors', 'ember', 'dummy/initializers/ember-validations'], function (exports, _emberQunit, _emberValidationsErrors, _ember, _dummyInitializersEmberValidations) {

  (0, _emberQunit.moduleForComponent)('flexberry-validationsummary', 'Integration | Component | flexberry-validationsummary', {
    integration: true,
    setup: function setup() {
      _dummyInitializersEmberValidations['default'].initialize();
    }
  });
  ...
  (0, _emberQunit.test)('it renders changing error list', function (assert) {
    var _this2 = this;

    var errors = _emberValidationsErrors['default'].create();
    _ember['default'].set(errors, 'testProperty', ['error1']);
    _ember['default'].set(this, 'errors', errors);
    ...
    var testPropertyErrorList = new _ember['default'].A(['error11', 'error12']);
    _ember['default'].run(function () {
      // Change existing errors property.
      _ember['default'].set(errors, 'testProperty', testPropertyErrorList);
    });
    ...
    _ember['default'].run(function () {
      ...
      _ember['default'].set(errors, 'testProperty2', ['error2']);
    });
    ...
    _ember['default'].run(function () {
      ...
      _ember['default'].get(errors, 'testProperty').popObject();
    });
    ...
    _ember['default'].run(function () {
      ...
      _ember['default'].get(errors, 'testProperty').pushObject('error13');
    });

    assert.equal(this.$().text().replace(/\n|\s/g, ""), 'error11error13error2');

    var errors2 = _emberValidationsErrors['default'].create();
    _ember['default'].set(errors2, 'testProperty2', ['error22']);
    _ember['default'].set(errors2, 'testProperty3', ['error3']);

    _ember['default'].run(function () {
      // Change errors object.
      _ember['default'].set(_this2, 'errors', errors2);
    });

    assert.equal(this.$().text().replace(/\n|\s/g, ""), 'error22error3');
  });
});
define('dummy/tests/integration/components/flexberry/validation-summary-test', ['exports', 'ember', 'ember-qunit'], function (exports, _ember, _emberQunit) {
  var A = _ember['default'].A;
  var run = _ember['default'].run;

  // eslint-disable-next-line ember/no-test-module-for
  (0, _emberQunit.moduleForComponent)('flexberry/validation-summary', 'Integration | Component | flexberry/validation-summary', {
    integration: true
  });
  ...
  (0, _emberQunit.test)('it renders and works', function (assert) {
    ...
    this.render(_ember['default'].HTMLBars.template((function () {
      return {
        ...
        statements: [['inline', 'flexberry/validation-summary', [], ['errors', ['subexpr', '@mut', [['get', 'errors', ['loc', [null, [1, 38], [1, 44]]]]], [], []], 'color', ['subexpr', '@mut', [['get', 'color', ['loc', [null, [1, 51], [1, 56]]]]], [], []], 'header', ['subexpr', '@mut', [['get', 'header', ['loc', [null, [1, 64], [1, 70]]]]], [], []]], ['loc', [null, [1, 0], [1, 72]]]]],
        locals: [],
        templates: []
      };
    })()));

    var errors = this.set('errors', A());
    ...
    this.render(_ember['default'].HTMLBars.template((function () {
      return {
        ...
        statements: [['content', 'flexberry/validation-summary', ['loc', [null, [1, 0], [1, 32]]]]],
        locals: [],
        templates: []
      };
    })()));
...
define('dummy/tests/integration/components/olv-filter-interval-test', ['exports', 'ember-qunit', 'ember', 'dummy/tests/helpers/start-app'], function (exports, _emberQunit, _ember, _dummyTestsHelpersStartApp) {
...
define('dummy/tests/unit/initializers/ember-validations-test', ['exports', 'ember', 'qunit', 'ember-validations/errors', 'dummy/initializers/ember-validations'], function (exports, _ember, _qunit, _emberValidationsErrors, _dummyInitializersEmberValidations) {
  var A = _ember['default'].A;
  var set = _ember['default'].set;

  (0, _qunit.module)('Unit | Initializer | ember-validations', {
  ...
  (0, _qunit.test)('it works', function (assert) {
    var errors = _emberValidationsErrors['default'].create();
    errors.on('errorListChanged', function () {
      assert.ok(true);
    });
...
define('dummy/tests/unit/routes/edit-form-new-test', ['exports', 'ember', 'ember-flexberry/routes/edit-form-new', 'ember-flexberry-data', 'qunit', 'dummy/tests/helpers/start-app', 'dummy/tests/helpers/destroy-app'], function (exports, _ember, _emberFlexberryRoutesEditFormNew, _emberFlexberryData, _qunit, _dummyTestsHelpersStartApp, _dummyTestsHelpersDestroyApp) {
  ...
  var getConfiguredTestRoute = function getConfiguredTestRoute(modelCurrentNotSaved, modelSelectedDetail) {
    ...
    var model = _emberFlexberryData.Projection.Model;
    model.defineProjection('testProjection', 'test-model');
    var detailInteractionServiceMock = _ember['default'].Object.create({
      modelCurrentNotSaved: !_ember['default'].isNone(modelCurrentNotSaved) && modelCurrentNotSaved ? model : null,
      modelSelectedDetail: !_ember['default'].isNone(modelSelectedDetail) && modelSelectedDetail ? model : null
    });
  ...
  (0, _qunit.module)('Unit | Route | edit form new', {
    beforeEach: function beforeEach() {
      app = (0, _dummyTestsHelpersStartApp['default'])();
    },
    afterEach: function afterEach() {
  ...
  (0, _qunit.test)('return model as Promise main', function (assert) {
    ...
    _ember['default'].run(function () {
      ...
      assert.equal(record instanceof _ember['default'].RSVP.Promise, true);
    });
  });
...
define('dummy/tests/unit/services/compatibility-validations-test', ['exports', 'ember', 'qunit', 'ember-validations/validators/local/absence', 'ember-validations/validators/local/acceptance', 'ember-validations/validators/local/confirmation', 'ember-validations/validators/local/exclusion', 'ember-validations/validators/local/format', 'ember-validations/validators/local/inclusion', 'ember-validations/validators/local/length', 'ember-validations/validators/local/numericality', 'ember-validations/validators/local/presence', 'ember-flexberry/services/compatibility-validations', 'dummy/tests/helpers/start-app'], function (exports, _ember, _qunit, _emberValidationsValidatorsLocalAbsence, _emberValidationsValidatorsLocalAcceptance, _emberValidationsValidatorsLocalConfirmation, _emberValidationsValidatorsLocalExclusion, _emberValidationsValidatorsLocalFormat, _emberValidationsValidatorsLocalInclusion, _emberValidationsValidatorsLocalLength, _emberValidationsValidatorsLocalNumericality, _emberValidationsValidatorsLocalPresence, _emberFlexberryServicesCompatibilityValidations, _dummyTestsHelpersStartApp) {
  var get = _ember['default'].get;

  (0, _qunit.module)('Unit | Service | compatibility-validations', function () {
    (0, _qunit.test)('it works', function (assert) {
      var app = (0, _dummyTestsHelpersStartApp['default'])();
      var service = _emberFlexberryServicesCompatibilityValidations['default'].create(app.__container__.ownerInjection());
      var cache = get(service, 'cache');

      assert.ok(cache.absence === _emberValidationsValidatorsLocalAbsence['default']);
      assert.ok(cache.acceptance === _emberValidationsValidatorsLocalAcceptance['default']);
      assert.ok(cache.confirmation === _emberValidationsValidatorsLocalConfirmation['default']);
      assert.ok(cache.exclusion === _emberValidationsValidatorsLocalExclusion['default']);
      assert.ok(cache.format === _emberValidationsValidatorsLocalFormat['default']);
      assert.ok(cache.inclusion === _emberValidationsValidatorsLocalInclusion['default']);
      assert.ok(cache.length === _emberValidationsValidatorsLocalLength['default']);
      assert.ok(cache.numericality === _emberValidationsValidatorsLocalNumericality['default']);
      assert.ok(cache.presence === _emberValidationsValidatorsLocalPresence['default']);
    });
  });
});
...
define('dummy/tests/unit/services/user-settings-test', ['exports', 'qunit', 'sinon', 'ember-flexberry/services/user-settings', 'ember'], function (exports, _qunit, _sinon, _emberFlexberryServicesUserSettings, _ember) {

  (0, _qunit.module)('Unit | Service | userSettings', {
    beforeEach: function beforeEach() {
      _sinon['default'].stub(_ember['default'], 'getOwner').returns({
  ...
  (0, _qunit.test)('get the set perPage', function (assert) {
    ...
    var service = _emberFlexberryServicesUserSettings['default'].create();
