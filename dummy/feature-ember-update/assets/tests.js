  ...
  (0, _executeFolvTest.executeTest)('check colsconfig column localization test', function (store, assert, app) {
    ...
    andThen(function () {
      ...
      function checkLocalization(currentLocale, locale) {
        ...
        var $configButton = Ember.$('.config-button');
        $configButton.click();
        ...
        var $closeModal = Ember.$('.close.icon');
        $closeModal.click();
      }

      (0, _folvTestsFunctions.loadingLocales)('en', app).then(function () {
        checkLocalization(_translations2.default, 'En');
...
define('dummy/tests/acceptance/components/flexberry-simpledatetime/flexberry-simpledatetime-manual-enter-test', ['qunit', 'dummy/tests/helpers/start-app'], function (_qunit, _startApp) {
  ...
  (0, _qunit.skip)('manual enter on groupedit', function (assert) {
    assert.expect(5);
    visit(path);
    andThen(function () {
      ...
      var $datePickers = Ember.$('.flatpickr-input.custom-flatpickr');
...
define('dummy/tests/acceptance/components/highload-edit-form-menu-test', ['qunit', 'dummy/tests/helpers/start-app', 'ember-test-helpers/wait'], function (_qunit, _startApp, _wait) {
  ...
  (0, _qunit.skip)('it properly renders', function (assert) {
    assert.expect(7);
    var done = assert.async();
