...
executeTest('check delete before record data immediately test', async (store, assert, app) => {
  assert.expect(5);
  const path = 'components-examples/flexberry-objectlistview/before-delete-record/folv-for-before-delete-record-data-immediately';
