...
Router.map(function() {
  ...
  this.route('components-examples/flexberry-lookup/compute-autocomplete/compute-autocomplete-edit.new',
    { path: 'components-examples/flexberry-lookup/compute-autocomplete/compute-autocomplete-edit/new' });
