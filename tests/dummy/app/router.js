...
Router.map(function() {
  ...
  this.route('components-examples/flexberry-lookup/numeric-autocomplete/numeric-autocomplete-list');
  this.route('components-examples/flexberry-lookup/numeric-autocomplete/numeric-autocomplete-edit',
    { path: 'components-examples/flexberry-lookup/numeric-autocomplete/numeric-autocomplete-edit/:id' });
