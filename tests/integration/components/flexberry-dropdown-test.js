...
module('Integration | Component | flexberry-dropdown', function(hooks) {
  ...
  test('it renders intl-ed placeholder', async function(assert) {
    ...
    assert.strictEqual(
      ...
      t('components.flexberry-dropdown.placeholder'),
  ...
  skip('needChecksOnValue mode properly', async function(assert) {
    ...
    await render(hbs`{{flexberry-dropdown
      ...
      needChecksOnValue=this.needChecksOnValue
    }}`);
