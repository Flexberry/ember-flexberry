...
module('Integration | Component | flexberry-field', function(hooks) {
  ...
  test('label mode works properly', async function(assert) {
    assert.expect(3);
  ...
  test('click on field in readonly mode doesn\'t change value & it\'s type', async function(assert) {
    assert.expect(3);
  ...
  test('it renders intl-ed placeholder', async function(assert) {
    ...
    assert.strictEqual(
      ...
      t('components.flexberry-field.placeholder'),
  ...
  test('type mode works properly', async function(assert) {
    // Render component.
    await render(hbs`{{flexberry-field
      class=this.class
      type=this.type
