...
module('Integration | Component | flexberry toggler', function(hooks) {
  ...
  let expandCollapseTogglerWithStateChecks = async function(assert, captions) {
    ...
    await render(hbs`
      {{#flexberry-toggler
        ...
        expandedCaption=this.expandedCaption
  ...
  test('component\'s icon can be customized', async function(assert) {
    assert.expect(2);
  ...
  test('component expands/collapses with defined \'expandedCaption\' & \'collapsedCaption\'', async function(assert) {
  ...
  test('component expands/collapses with defined \'caption\' & \'collapsedCaption\'', async function(assert) {
    expandCollapseTogglerWithStateChecks.call(this, assert, {
  ...
  test('component expands/collapses with defined \'caption\' & \'expandedCaption\'', async function(assert) {
    expandCollapseTogglerWithStateChecks.call(this, assert, {
      caption: 'Toggler\'s caption',
      expandedCaption: 'Toggler\'s expanded caption'
    });
  ...
  test('component expands/collapses with only \'caption\' defined', async function(assert) {
    expandCollapseTogglerWithStateChecks.call(this, assert, {
      caption: 'Toggler\'s caption'
    });
  });

  test('component expands/collapses with only \'expandedCaption\' defined', async function(assert) {
    expandCollapseTogglerWithStateChecks.call(this, assert, {
      expandedCaption: 'Toggler\'s expanded caption'
    });
  });

  test('component expands/collapses with only \'collapsedCaption\' defined', async function(assert) {
    expandCollapseTogglerWithStateChecks.call(this, assert, {
      collapsedCaption: 'Toggler\'s collapsed caption'
    });
  });

  test('component expands/collapses without defined captions', async function(assert) {
    expandCollapseTogglerWithStateChecks.call(this, assert, {
    });
  });

  test('changes in \'expanded\' property causes changing of component\'s expand/collapse state', async function(assert) {
    assert.expect(9);
  ...
  test('disabled animation', async function(assert) {
    await render(hbs`
      {{#flexberry-toggler
        caption="Click me!"
        duration=0}}
    ...
    assert.notOk($('.flexberry-toggler .content', this.element).hasClass('active'));

    await $('.flexberry-toggler .title', this.element).click();
    await settled();
  ...
  test('Components property hasShadow works properly', async function(assert) {
    ...
    assert.notOk($('.flexberry-toggler', this.element).hasClass('has-shadow'));
  });
  ...
  test('Components property hasBorder works properly', async function(assert) {
    ...
    assert.notOk($('.flexberry-toggler', this.element).hasClass('has-border'));
  });
});
